...
class HomeDatasourceImplements(private val repository: HomeRepository) :
    ...
    override fun getIdRecentlySeenItem(): String = repository.getIdRecentlySeenItem()

    override fun setIdRecentlySeenItem(id: String) = repository.setIdRecentlySeenItem(id)

    override fun setCountItem(count: Int) = repository.setCountItem(count)

    override fun setLinkRecentlySeen(id: String) = repository.setLinkRecentlySeen(id)

    override fun setSearchPosition(position: Int) = repository.setSearchPosition(position)
   }